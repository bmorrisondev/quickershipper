...
exports.createShipments = async(event, context) => {
...
exports.purchaseShipments = async(event, context) => {
    ...
    let paymentResult = await paymentsController.createCharge(requestBody.cardToken, totalEasypostCharges, 'QuickerShipper Label Purchase');
